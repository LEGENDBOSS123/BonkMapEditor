...
async function animate() {
    ...
    if (hasChanged()) {
        ...
        ctx.fillText(`Press Shift+T to enter JSON text, Shift+J to copy JSON, Shift+S to enter map string, Shift+C to copy map string`, 10, 40);
        let notifY = 80;
...
document.addEventListener('keydown', async (e) => {
    ...
    switch (e.code) {
        ...
        case "KeyJ":
            ...
            addNotification("Map JSON copied to clipboard", 3000, "lightgreen");
            addNotification(jsonString, 3000);
            break;
        case "KeyT":
